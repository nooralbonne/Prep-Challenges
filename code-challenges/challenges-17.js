...
const recursionPattern = (int1, int2, patternArr = []) => {
    // write your code here
    if (int1 < 0) {
        patternArr.push(int1);
        return patternArr;
    }

    patternArr.push(int1);
    recursionPattern(int1 - int2, int2, patternArr);
    patternArr.push(int1);
...
const filterLinks = (str) => {
    // write your code here
    let link = /href="(?:https?:\/\/)?([^"]*\.(?:com|org|net))"/;


    const match = str.match(link); 
