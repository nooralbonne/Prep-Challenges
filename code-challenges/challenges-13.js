...
const objectCounter = (obj) => {
    ...
    let objCount = obj.reduce((count, currentValue) => {
        return count +1
    }, 0)
    return objCount
}
...
const stringReverse = (str) => {
    ...
    const revStr = wordStr.reduce((accumulator, currentValue) => {
...
const statistics = (obj) => {
    ...
    let res = obj.reduce((accumulator, currentValue) => {
        accumulator[currentValue.votes_To] = (accumulator[currentValue.votes_To] || 0) +1
        return accumulator
    }, {})
    return res
}
